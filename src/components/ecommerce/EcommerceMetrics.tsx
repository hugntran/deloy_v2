...
export default function EcommerceMetrics() {
  ...
  const fetchLocations = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://18.182.12.54:8082/app-data-service/locations/nearby?longitude=${longitude}&latitude=${latitude}&maxDistance=100&page=0&size=100`, {
        headers: {
