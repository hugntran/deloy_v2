...
export default function Ecommerce() {
  ...
  const fetchTotalRevenue = async () => {
    ...
    try {
      const res = await fetch(`http://18.182.12.54:8082/app-data-service/api/invoices/revenue/grouped?${params.toString()}`, {
        headers: {
  ...
  const fetchInvoiceAndRefundCount = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://18.182.12.54:8082/app-data-service/bookings/stats/counts?${params.toString()}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
  ...
  const fetchChangeTimePaymentCount = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://18.182.12.54:8082/app-data-service/api/invoices?${params.toString()}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
  ...
  const fetchComplaintCount = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://18.182.12.54:8086/dispute/api/stats/counts?${params.toString()}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
