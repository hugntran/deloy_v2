...
const CreateVoucher = () => {
  ...
  const validateForm = () => {
    ...
    // Kiểm tra discountAmount, maxUsagePerUser, totalUsageLimit
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const uploadRes = await axios.post<string[]>("http://18.182.12.54:8085/file/aws/upload-images", formData, {
      ...
      await axios.post("http://18.182.12.54:8084/payment/vouchers/create", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
