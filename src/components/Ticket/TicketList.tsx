...
function TicketList() {
  ...
  const {
    ...
    url: `http://18.182.12.54:8082/app-data-service/locations/nearby?longitude=105.779303&latitude=21.028759&maxDistance=100&page=0&size=100`,
  });
    ...
    const fetchAllTickets = async () => {
      ...
      try {
        ...
        do {
          ...
          }>(`http://18.182.12.54:8082/app-data-service/tickets/pageable/find?locationId=${locationId}&page=${page}&size=${pageSize}`);
  ...
  const { data: checkoutTickets = [] } = useFetchData<any>({
    url: `http://18.182.12.54:8082/app-data-service/tickets/checkout-requests?page=0&size=100`,
  ...
  const { data: CheckinTickets = [] } = useFetchData<any>({
    url: `http://18.182.12.54:8082/app-data-service/tickets/checkin-requests?page=0&size=100`,
  ...
  useEffect(() => {
    const fetchVerifyRequired = async () => {
      if (locationId) {
        try {
          const res = await fetchWithAuth(`http://18.182.12.54:8082/app-data-service/tickets/verify-required?locationId=${locationId}&page=0&size=100`);
  ...
  useEffect(() => {
    const fetchChangeTimeTickets = async () => {
      if (locationId) {
        try {
          const res = await fetchWithAuth(`http://18.182.12.54:8082/app-data-service/tickets/verify-required-change-time?page=0&size=100&sort=startDateTime,desc`);
