...
function ExtendTab({ tickets, onReassignSuccess }: ExtendTabProps) {
  ...
  // Hàm để mở hộp thoại xác nhận khi người dùng nhấn Accept hoặc Reject
  ...
  // Hàm xác nhận hành động và gọi API
  const handleConfirmAction = async () => {
    const token = localStorage.getItem("authToken");
    const url =
      actionType === "accept"
        ? `http://18.182.12.54:8082/app-data-service/tickets/confirm-extension/${ticketToHandle}`
        : `http://18.182.12.54:8082/app-data-service/tickets/reject-extension/${ticketToHandle}`;
    ...
    try {
      ...
      // Đóng hộp thoại sau khi hành động thành công
                                    ...
                                    <TableCell>
                                      <Button
                                        ...
                                        sx={{
                                          ...
                                          color: "white",
                                          "&:hover": {
                                            backgroundColor: "#0069d9", // hover đậm hơn
                                          },
                                        }}
                                      >
                                        Change slot
