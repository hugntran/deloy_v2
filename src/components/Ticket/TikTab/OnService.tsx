...
export default function OnServiceTab({ tickets, locationId }: OnServiceTabProps) {
  ...
  useEffect(() => {
    const fetchSlots = async () => {
      ...
      try {
        const data = await fetchWithAuth(`http://18.182.12.54:8082/app-data-service/slots/find-pageable-slots?page=0&size=1000&locationId=${locationId}`);
